...
export default function Programmers() {
  ...
  const [ prog, progArr ] = useState(listOfAwesome);
  const [ featProg, setFeatured ] = useState(null);
  ...
  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: featProg != null ? 'royalblue' : 'gold', // 🤔 color turns to gold, when celebrating
  };
